...
for (township in townships) {
  ...
  temperature_min_ts[missing_min_values] <- approx(
  ...
  temperature_max_ts[missing_max_values] <- approx(
...
temperature.daily_avg$lag2_HDD <-
  c(NA, NA, temperature.daily_avg$HDD[-(nrow(temperature.daily_avg)):-(nrow(temperature.daily_avg) - 1)])
